    ...
    <div className="container pt-16">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-4 items-center">
        <div className="col-span-1 lg:col-span-6 flex flex-col gap-4">
          <h2 className="text-2xl lg:text-3xl xl:text-4xl font-extrabold text-primary uppercase text-center lg:text-left">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4">
            ...
            <div className="flex flex-col">
              <p className="text-primary font-bold text-center lg:text-start">
        ...
        <div className="col-span-1 lg:col-span-6 rounded-md overflow-hidden shadow-lg">
          <iframe
