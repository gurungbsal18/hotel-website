  ...
  return (
    <>
      <div className="bg-primary flex flex-col justify-center items-center gap-8 text-white py-16 mt-16">
        <div className="flex flex-col gap-2 justify-center items-center w-full md:w-3/4 lg:w-3/6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 w-full gap-8">
          <span className="col-span-1 md:col-span-4 flex flex-col justify-center items-center gap-1">
